...
- **connor** — основной ассистент: память, напоминания, todo, инвентарь, обучение, проактивность, веб-поиск, файлы.
...
- **verso_ru_group** — персона для русскоязычного группового чата.
