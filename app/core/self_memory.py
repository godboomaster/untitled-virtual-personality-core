...
MAX_ACTIVE_EPISODES = 10    # сколько эпизодов в промпте
MAX_ARCHIVE_EPISODES = 40   # архив перед суммаризацией
MAX_NOTES = 15              # заметок в промпте
MIN_NOTE_INTERVAL = 10      # минимум сообщений между заметками
MIN_MSG_LEN_FOR_NOTE = 40   # минимальная длина сообщения для заметки
...
Напиши подробную личную заметку (5-8 предложений) от первого лица.
